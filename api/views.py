...
def image_to_image(request):
    return render(request, "image_to_image.html")

class StableDiffusionTextToImageAPIView(APIView):
...
class StableDiffusionImageToImageAPIView(APIView):
    permission_classes = [permissions.AllowAny,]
    ...
    def post(self, request, *args, **kwargs):
        ...
        end_point = 'https://stablediffusionapi.com/api/v3/img2img'
        data = {
            "key": settings.STABLE_DIFFUSION_API_KEY,
            "prompt": prompt,
